...
$query = "select * from product where category_id='bookmark'";
$result = mysqli_query($link, $query);
	...
	while($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
	{
		...
		$unit_price = $row['unit_price'];
			...
			echo "			<img alt='product_id' src='images/$product_id' class='product-grid_img'/>";
			echo '		</div>';
			...
			echo "				<input name='qty' id=qty value=1 type=hidden />";
