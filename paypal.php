...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
      ...
      $p->add_field('business', 'daphne.seller@tafesait.org');
      $p->add_field('return', $this_script.'?action=success');
      $p->add_field('cancel_return', $this_script.'?action=cancel');
      $p->add_field('notify_url', $this_script.'?action=ipn');
      $p->add_field('item_name', 'Paypal Test Transaction'); // Transaction name
   ...
   case 'success':      // Order was successful...
	  ...
	  //OR filter the information you want to show the customer
	  ...
	  foreach ($_POST as $key => $value)
	  {
		  ...
		  if($key == "payer_email")
			  echo "Email :$value<br>";
		  if($key == "mc_gross")
			  echo "Total amount: $value<br>";
		 // if($key == "tax")
			//  echo "Tax: $value<br>";
		  if($key == "txn_id")
			  echo "Invoice No.: $value<br>";
		  if($key == "payment_status")
			  echo "Payment Status: $value<br>";
		  if($key == "payment_date")
			  echo "Payment Date: $value<br>";
	  }
   ...
   case 'ipn':          // Paypal is calling page for IPN validation...
      ...
      if ($p->validate_ipn()) {
         ...
         $to = 'daphne.buyer@tafesait.org';    //  your email(buyer email)
